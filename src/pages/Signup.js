// src/pages/Signup.js - WITH ROLE SELECTION
...
export default function Signup() {
  ...
  const roles = [
    { value: "Employee", label: "Employee", desc: "Regular employee access" },
    { value: "HR", label: "HR Recruiter", desc: "Manage recruitment and employees" },
    { value: "Senior Manager", label: "Senior Manager", desc: "View reports and reviews" },
    { value: "Admin", label: "Admin", desc: "Full system access" },
    { value: "Management Admin", label: "Management Admin", desc: "Highest level access" }
  ];
  ...
  const doGoogle = async () => {
    ...
    setLoading(true);
    try {
      // Google signup will default to Employee role
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-purple-50 p-4">
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8">
        <div className="text-center mb-6">
          ...
          <p className="text-gray-600 mt-2">Join our HRMS platform</p>
        </div>
